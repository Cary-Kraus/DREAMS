...
namespace DREAMS
{
    public class MyGame : AdventureGame
    {
        ...
        static Image imForest1 = Image.FromFile(@"Sprites\лес1.png");
        ...
        static Image imActorRight0 = Image.FromFile(@"Sprites\actorright0.png"); //стоит вправо
        static Image imActorLeft0 = Image.FromFile(@"Sprites\actorleft0.png"); //стоит влево
        ...
        static Image imGhost0 = Image.FromFile(@"Sprites\ghost0.png"); //стоит
        static Image imGhost1 = Image.FromFile(@"Sprites\ghost1.png"); //пугает
        //public static Image imGhost2 = Image.FromFile(@"Sprites\ghost2.png"); //сильно пугает

        static Image imWeepingAngel1 = Image.FromFile(@"Sprites\angel1.png"); //ангел без венка
        //public static Image imWeepingAngel2 = Image.FromFile(@"Sprites\angel2.png"); //ангел с венком
        static Image imCrown = Image.FromFile(@"Sprites\crown.png"); //венок
        ...
        public Actor act = new Actor(sActorLeft0);
        public MyGame()
        {
